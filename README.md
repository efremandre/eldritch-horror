...
[>> Демка готового проекта <<](https://efremandre.github.io/eldritch-horror/index.html)
...
Информация о картах выводится так же в консоль, чтобы было удобно отслеживать работу алгоритма.
...
Вырезка из правил игры о сборе колод
